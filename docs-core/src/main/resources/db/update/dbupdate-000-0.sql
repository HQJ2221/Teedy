...
create memory table T_USER_REGISTER_REQUEST ( URR_ID_C varchar(36) not null, URR_EMAIL_C varchar(50) not null, URR_USERNAME_C varchar(50) not null, URR_STATUS_C varchar(20) not null, URR_CREATEDATE_D datetime, URR_PROCESSDATE_D datetime, primary key (URR_ID_C) );
